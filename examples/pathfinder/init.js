...
addDebugOption("iter", "Iterations", "number", 20);
addDebugOption("jitter", "Jitter", "number", 0);
addDebugOption("boxes", "Hitboxes", "bool", false);

setDebugMenu(true);

Resource.loadTexture("../res/tile_set_02.png", "terrain");
